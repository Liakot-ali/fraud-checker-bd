...
(function (global) {
  ...
  var I18N = {
    en: {
      ...
      'card.verified': 'VERIFIED', 'card.loss': 'Loss Amount', 'card.item': 'Item', 'card.location': 'Location',
      ...
      'modal.fraudster': '🔴 VERIFIED FRAUDSTER', 'modal.nickname': 'Nickname', 'modal.fraud_details': '📋 Fraud Details',
      ...
      'submit.proof': 'Proof of the Scam', 'submit.proof_hint': 'Screenshots, images, videos or documents (max 20 files total, 50MB each)',
      ...
      // event detail
      'detail.loading': 'Loading event details…', 'detail.subtitle': 'Verified Fraudster', 'detail.loss': 'Loss Amount', 'detail.scam_type': 'Scam Type', 'detail.location': 'Location',
      ...
      // imposter profile
      'profile.loading': 'Loading imposter profile…', 'profile.verified_profile': 'Verified Fraudster Profile',
      ...
      'profile.status_verified': '🔴 Verified', 'profile.contact': '📱 Known Contact Information', 'profile.details': 'ℹ️ Profile Details',
    ...
    bn: {
      ...
      'card.verified': 'যাচাইকৃত', 'card.loss': 'ক্ষতির পরিমাণ', 'card.item': 'যা হারিয়েছে', 'card.location': 'অবস্থান',
      ...
      'modal.fraudster': '🔴 যাচাইকৃত প্রতারক', 'modal.nickname': 'ডাকনাম', 'modal.fraud_details': '📋 প্রতারণার বিবরণ',
      ...
      'submit.proof': 'প্রতারণার প্রমাণ', 'submit.proof_hint': 'স্ক্রিনশট, ছবি, ভিডিও বা ডকুমেন্ট (সর্বোচ্চ ২০টি ফাইল, প্রতিটি ৫০MB)',
      ...
      'detail.loading': 'ঘটনার বিবরণ লোড হচ্ছে…', 'detail.subtitle': 'যাচাইকৃত প্রতারক', 'detail.loss': 'ক্ষতির পরিমাণ', 'detail.scam_type': 'প্রতারণার ধরন', 'detail.location': 'অবস্থান',
      ...
      'profile.loading': 'প্রতারকের প্রোফাইল লোড হচ্ছে…', 'profile.verified_profile': 'যাচাইকৃত প্রতারকের প্রোফাইল',
      'profile.total': 'মোট ঘটনা', 'profile.total_loss': 'মোট ক্ষতি', 'profile.last_active': 'সর্বশেষ সক্রিয়', 'profile.status': 'প্রোফাইলের অবস্থা',
      'profile.status_verified': '🔴 যাচাইকৃত', 'profile.contact': '📱 জানা যোগাযোগের তথ্য', 'profile.details': 'ℹ️ প্রোফাইলের বিবরণ',
