...
(function (global) {
  ...
  var I18N = {
    en: {
      ...
      'submit.paste': '⚡ Quick start — paste your post or drop screenshots',
      'submit.paste_hint': "Already posted about it on Facebook? Paste that text, and/or add the scam screenshots and the fraudster's ID card. We'll read them and fill the form for you — you just review and submit. The pictures you add here are also attached as evidence.",
      'submit.paste_ph': 'Paste the message or your social post here…', 'submit.paste_btn': 'Read & fill the form',
      'submit.quick_images': 'Screenshots, ID card, or other pictures (we read these)',
      'submit.quick_reading': 'Reading your pictures… this can take a moment.',
      'submit.quick_fail': 'Could not read the pictures — please fill the form manually.',
      'submit.paste.phone': 'phone', 'submit.paste.trxid': 'transaction ID', 'submit.paste.desc': 'description', 'submit.paste.nid': 'NID', 'submit.paste.amount': 'loss amount', 'submit.paste.proofs': '{n} picture(s) attached as evidence',
    ...
    bn: {
      ...
      'submit.paste': '⚡ দ্রুত শুরু — আপনার পোস্ট পেস্ট করুন বা স্ক্রিনশট দিন',
      'submit.paste_hint': 'ফেসবুকে ঘটনাটি নিয়ে পোস্ট করেছেন? সেই লেখা পেস্ট করুন, এবং/অথবা প্রতারণার স্ক্রিনশট ও প্রতারকের আইডি কার্ড যোগ করুন। আমরা সেগুলো পড়ে ফর্মটি পূরণ করে দেব — আপনি শুধু দেখে জমা দেবেন। এখানে দেওয়া ছবিগুলো প্রমাণ হিসেবেও সংযুক্ত হবে।',
      'submit.paste_ph': 'বার্তা বা আপনার সোশ্যাল পোস্ট এখানে পেস্ট করুন…', 'submit.paste_btn': 'পড়ে ফর্ম পূরণ করুন',
      'submit.quick_images': 'স্ক্রিনশট, আইডি কার্ড বা অন্য ছবি (আমরা এগুলো পড়ব)',
      'submit.quick_reading': 'আপনার ছবিগুলো পড়া হচ্ছে… একটু সময় লাগতে পারে।',
      'submit.quick_fail': 'ছবিগুলো পড়া যায়নি — অনুগ্রহ করে নিজে ফর্ম পূরণ করুন।',
      'submit.paste.phone': 'ফোন', 'submit.paste.trxid': 'ট্রানজেকশন আইডি', 'submit.paste.desc': 'বিবরণ', 'submit.paste.nid': 'এনআইডি', 'submit.paste.amount': 'ক্ষতির পরিমাণ', 'submit.paste.proofs': '{n}টি ছবি প্রমাণ হিসেবে যুক্ত হয়েছে',
