...
(function (global) {
  ...
  var I18N = {
    en: {
      ...
      'submit.paste': '⚡ Quick start — paste your post & drop the documents',
      'submit.paste_hint': "Already wrote about it on Facebook? Paste that text — we use it for the description. Add the fraudster's NID and any photos/screenshots — we read the name, phone number(s) and address from them, and set the imposter's photo. Everything stays editable, and the pictures are attached as evidence.",
      'submit.paste_ph': 'Paste your social post or the message here (used for the description)…', 'submit.paste_btn': 'Read & fill the form',
      'submit.quick_images': "NID, the fraudster's photo, or screenshots (we read these)",
      'submit.quick_reading': 'Reading your documents… this can take a moment.',
      'submit.quick_fail': 'Could not read the pictures — please fill the form manually.',
      'submit.quick_empty': 'Paste some text or add a picture first.',
      'submit.ai_consent': '✨ Use AI for more accurate reading. I understand my pasted text and pictures will be sent to Google Gemini to help fill this form. (Without this, basic on-device reading is used.)',
      'submit.ai_busy': 'AI was unavailable — used basic reading instead. Please review the fields.',
      'submit.paste.phone': 'phone', 'submit.paste.altphones': 'extra phone number(s)', 'submit.paste.name': 'name', 'submit.paste.address': 'address', 'submit.paste.social': 'social media', 'submit.paste.scamtype': 'scam type', 'submit.paste.image': 'imposter photo', 'submit.paste.trxid': 'transaction ID', 'submit.paste.desc': 'description', 'submit.paste.nid': 'NID', 'submit.paste.amount': 'loss amount', 'submit.paste.proofs': '{n} picture(s) attached as evidence',
      'submit.paste.done': 'Filled: {items}. Please review everything before submitting.', 'submit.paste.ai_done': '✨ AI filled: {items}. Please review everything before submitting.', 'submit.paste.none': 'Nothing recognisable found — please fill the form manually.',
      'submit.paste.wallet': 'receiving wallet (money sent to)', 'submit.paste.provider': 'payment provider', 'submit.paste.reporter_name': 'your name (reporter)', 'submit.paste.reporter_phone': 'your number (reporter)',
      'submit.qs_review': 'Here is what we found and filled in — please check each one:', 'submit.qs_lowconf': '⚠ The highlighted (amber) fields are our best guess — please double-check them.', 'submit.qs_undo': '↩ Undo auto-fill', 'submit.qs_undone': 'Auto-fill undone — the fields were restored.',
    ...
    bn: {
      ...
      'submit.paste': '⚡ দ্রুত শুরু — আপনার পোস্ট পেস্ট করুন ও কাগজপত্র দিন',
      'submit.paste_hint': 'ফেসবুকে ঘটনাটি নিয়ে লিখেছেন? সেই লেখা পেস্ট করুন — এটি বিবরণে ব্যবহার হবে। প্রতারকের এনআইডি ও ছবি/স্ক্রিনশট যোগ করুন — আমরা সেখান থেকে নাম, ফোন নম্বর ও ঠিকানা পড়ে নিই এবং প্রতারকের ছবি বসিয়ে দিই। সব কিছু সম্পাদনাযোগ্য, আর ছবিগুলো প্রমাণ হিসেবেও যুক্ত হয়।',
      'submit.paste_ph': 'আপনার সোশ্যাল পোস্ট বা বার্তা এখানে পেস্ট করুন (বিবরণে ব্যবহার হবে)…', 'submit.paste_btn': 'পড়ে ফর্ম পূরণ করুন',
      'submit.quick_images': 'এনআইডি, প্রতারকের ছবি বা স্ক্রিনশট (আমরা এগুলো পড়ব)',
      'submit.quick_reading': 'আপনার কাগজপত্র পড়া হচ্ছে… একটু সময় লাগতে পারে।',
      'submit.quick_fail': 'ছবিগুলো পড়া যায়নি — অনুগ্রহ করে নিজে ফর্ম পূরণ করুন।',
      'submit.quick_empty': 'আগে কিছু লেখা পেস্ট করুন বা একটি ছবি দিন।',
      'submit.ai_consent': '✨ আরও নির্ভুলভাবে পড়তে AI ব্যবহার করুন। আমি বুঝি যে ফর্ম পূরণে সাহায্যের জন্য আমার পেস্ট করা লেখা ও ছবিগুলো Google Gemini-তে পাঠানো হবে। (এটি না দিলে ডিভাইসেই সাধারণভাবে পড়া হবে।)',
      'submit.ai_busy': 'AI পাওয়া যায়নি — সাধারণভাবে পড়া হয়েছে। অনুগ্রহ করে ঘরগুলো দেখে নিন।',
      'submit.paste.phone': 'ফোন', 'submit.paste.altphones': 'অতিরিক্ত ফোন নম্বর', 'submit.paste.name': 'নাম', 'submit.paste.address': 'ঠিকানা', 'submit.paste.social': 'সোশ্যাল মিডিয়া', 'submit.paste.scamtype': 'প্রতারণার ধরন', 'submit.paste.image': 'প্রতারকের ছবি', 'submit.paste.trxid': 'ট্রানজেকশন আইডি', 'submit.paste.desc': 'বিবরণ', 'submit.paste.nid': 'এনআইডি', 'submit.paste.amount': 'ক্ষতির পরিমাণ', 'submit.paste.proofs': '{n}টি ছবি প্রমাণ হিসেবে যুক্ত হয়েছে',
      'submit.paste.done': 'পূরণ হয়েছে: {items}। জমা দেওয়ার আগে সব দেখে নিন।', 'submit.paste.ai_done': '✨ AI পূরণ করেছে: {items}। জমা দেওয়ার আগে সব দেখে নিন।', 'submit.paste.none': 'চেনার মতো কিছু পাওয়া যায়নি — অনুগ্রহ করে নিজে পূরণ করুন।',
      'submit.paste.wallet': 'যে ওয়ালেটে টাকা পাঠানো হয়েছে', 'submit.paste.provider': 'পেমেন্ট মাধ্যম', 'submit.paste.reporter_name': 'আপনার নাম (রিপোর্টকারী)', 'submit.paste.reporter_phone': 'আপনার নম্বর (রিপোর্টকারী)',
      'submit.qs_review': 'আমরা যা পেয়েছি ও পূরণ করেছি — অনুগ্রহ করে প্রতিটি মিলিয়ে নিন:', 'submit.qs_lowconf': '⚠ হলুদ চিহ্নিত ঘরগুলো আমাদের অনুমান — অনুগ্রহ করে ভালো করে যাচাই করুন।', 'submit.qs_undo': '↩ স্বয়ংক্রিয় পূরণ বাতিল করুন', 'submit.qs_undone': 'স্বয়ংক্রিয় পূরণ বাতিল হয়েছে — ঘরগুলো আগের অবস্থায় ফিরেছে।',
