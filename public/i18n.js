...
(function (global) {
  ...
  var I18N = {
    en: {
      ...
      'submit.paste.phone': 'phone', 'submit.paste.altphones': 'extra phone number(s)', 'submit.paste.name': 'name', 'submit.paste.address': 'address', 'submit.paste.image': 'imposter photo', 'submit.paste.trxid': 'transaction ID', 'submit.paste.desc': 'description', 'submit.paste.nid': 'NID', 'submit.paste.amount': 'loss amount', 'submit.paste.proofs': '{n} picture(s) attached as evidence',
      'submit.paste.done': 'Filled: {items}. Please review everything before submitting.', 'submit.paste.none': 'Nothing recognisable found — please fill the form manually.',
    ...
    bn: {
      ...
      'submit.paste.phone': 'ফোন', 'submit.paste.altphones': 'অতিরিক্ত ফোন নম্বর', 'submit.paste.name': 'নাম', 'submit.paste.address': 'ঠিকানা', 'submit.paste.image': 'প্রতারকের ছবি', 'submit.paste.trxid': 'ট্রানজেকশন আইডি', 'submit.paste.desc': 'বিবরণ', 'submit.paste.nid': 'এনআইডি', 'submit.paste.amount': 'ক্ষতির পরিমাণ', 'submit.paste.proofs': '{n}টি ছবি প্রমাণ হিসেবে যুক্ত হয়েছে',
      'submit.paste.done': 'পূরণ হয়েছে: {items}। জমা দেওয়ার আগে সব দেখে নিন।', 'submit.paste.none': 'চেনার মতো কিছু পাওয়া যায়নি — অনুগ্রহ করে নিজে পূরণ করুন।',
